...
if (registrationForm) {
  registrationForm.addEventListener("submit", async (e) => {
    ...
    const str = config?.strings?.login || {};
    ...
    try {
      ...
      if (res.ok && data.success) {
        status.textContent =
          str.successRegistered || "Registered successfully! Logging in...";
  ...
  loginForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        status.textContent =
          str.errorInvalidCredentials || "Invalid credentials";
      }
    } catch (err) {
      status.textContent =
        str.errorNetwork || "Network error or server is down.";
